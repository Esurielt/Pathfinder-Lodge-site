---
{"dg-publish":true,"permalink":"/PF2E Resources - Chinese/1-Player-Core-Ch1-CN/","title":"玩家核心书：导言","pinned":true,"tags":["中文"],"noteIcon":"","updated":"2024-01-20T05:26:32.175-08:00"}
---
...
你可以在回合中使用一次以上的 "打击 "动作，但第一次攻击后的每一次额外攻击都会降低准确度。第二次攻击时的==**多重攻击减值** Multiple Attack Penalty== 为-5，第三次则会增加到-10。有很多方法可以减少这种惩罚，而且它会在你的回合结束时重置。

如果你的角色发现自己是魔法闪电的目标或毒蛇咬伤的目标，你将需要尝试一次==**豁免检定** Saving Throw==，这代表了你的角色躲避危险或以其他方式抵御身心攻击的能力。豁免是针对法术的DC或角色特殊能力的 DC 所做的检定。有三种类型的豁免检定，每种豁免的熟练度都表现着一个角色的承受能力。==**强韧豁免** Fortitude== 用于判断角色的健康或生命力受到的攻击（如中毒或疾病）。==**反射豁免** Reflex ==用于判断角色对危险的躲避（通常是影响大片区域的危险，如火球术的灼烧）。==**意志豁免** Will ==则通常用于抵御针对角色心灵的咒语和效果，例如魅惑或迷惑咒语。在所有的豁免检定中，成功结果会减轻有害影响，而获得大成功通常意味着你的角色毫发无损。

攻击、法术、危险和特殊能力经常会对角色造成==**伤害**==或施加一个或多个==**状态** Conditions==，有时两者兼而有之。伤害会从生物的==**生命值**（HP）==中扣除——HP 是衡量生物健康状况的指标——当生物的 HP 降为 0 时，它就会失去知觉并可能死亡！一场战斗通常会持续到一方被打败为止，而这可能意味着撤退或投降，但更多的时候意味着一方全部死亡或濒死。状态会短时间干扰角色能力，限制ta可做出的动作或对接下来的检定给予减值。有些状态是永久的，需要角色寻找强大的魔法来解除。

### 休整期
PC们 不一定要把所有时间都花在冒险上。他们也可能会养伤，计划未来的征战，甚至从事贸易。在开拓者游戏中，这称之为休整期，它可以让角色在完成长期任务或目标时快速略过一部分时间。大多数角色都可以在休整期内锻炼技能，赚取一些金币，拥有适当技能的角色甚至可以花时间制作工艺品，创造新装备甚至魔法物品。角色还可以利用休整期进行重训，替换另一种角色选择，以反映他们重视的事情在不断发展与变化。他们还可以研究问题、学习新法术，甚至经营企业或王国！

---

### 关键术语
这里有不少重要术语是你在创建你的第一个角色或冒险时所要知道的。前文提及的一些重要术语亦包含于此，以供参考。

#### 动作 Action 
每场遭遇战中，每个角色每回合都可以执行3次动作。这些动作可以用于攻击、与物品交互、移动或使用特殊能力。所有角色都可以使用的动作可以参考第八章。 
[[PF2E Resources - Chinese/3-Player-Reference-Card-CN\|玩家参考卡]]  | [苹果园新版翻译](http://45.79.87.129/bbs/index.php?topic=144679.msg1263343#msg1263343:~:text=%E6%89%93%E5%87%BB%E5%9F%BA%E7%A1%80%E5%8A%A8%E4%BD%9C%E3%80%82-,%E5%9F%BA%E7%A1%80%E5%8A%A8%E4%BD%9C%20Basic%20Actions,-%E5%9F%BA%E7%A1%80%E5%8A%A8%E4%BD%9C%E4%BB%A3%E8%A1%A8) | [中文维基基本动作速查（规则不完全）](https://pf2.huijiwiki.com/wiki/%E5%9F%BA%E6%9C%AC%E5%8A%A8%E4%BD%9C%E9%80%9F%E6%9F%A5)| [英文SRD参考](https://2e.aonprd.com/Rules.aspx?ID=439)
#### 族裔 Ancestry
族裔指的是一个角色所归属的广泛群组。族裔决定了某个角色开局时的生命值、语言、感官和速度，并且每个族裔提供特殊的族裔专长可供选择。族裔相关内容可以在第二章中找到。
（请参考[[PF2E Resources - Chinese/2-Character-Creation-Guide-CN\|车卡指南]]）
#### 护甲等级 Armor Class （AC）
游戏内的所有生物都拥有护甲等级（AC）。该数值代表了命中并伤害一个生物有多困难。它可以作为衡量使用一次攻击命中生物时的困难等级。
#### 攻击 Attack
当一个生物试图伤害另一个生物，它会作出一次“打击”或使用一些其他的攻击动作。大部分攻击是用武器作出“打击”，但某些角色可能使用拳头进行打击、使用双手擒拿或推撞、或使用法术攻击。
#### 属性调整值 Attribute Modifier
每个生物拥有六种属性值：力量、敏捷、体质、智力、感知和魅力。这些数值代表了某个生物的基础潜力和基本特征。数值越高，该生物在此属性上的潜力也就越大。属性值将在本章的后续内容中详细介绍。
#### 背景 Background
背景代表一个角色在他们接受冒险者生活之前经历过些什么。每个背景提供一个专长及一或多个受训技能。你可以在第二章中阅读到更多背景相关内容。
（请参考[[PF2E Resources - Chinese/2-Character-Creation-Guide-CN\|车卡指南]]）
#### 加值和减值 Bonuses and Penalties
加值和减值用于检定结果和某些统计数据。加值和减值有数种类型。如果拥有一种以上的同类型加值，你只能应用最大加值。同样的，你也只适用最大的同类型减值。
#### 检定 Check
当一个角色在难以预料结果的情况下试图执行动作时，Ta需要进行一次检定。这需要投掷一枚20面骰子，加上所需的熟练度加成。例如，一个察觉检定需要加上你的察觉熟练度。
#### 职业 Class
职业代表一个角色所选择的冒险专精之道。一个角色的职业决定了其大部分的熟练度，每当获得新等级时为其提供生命值，并且允许其获得一套职业专长。职业相关内容出现在第三章。
（请参考[[PF2E Resources - Chinese/2-Character-Creation-Guide-CN\|车卡指南]]）
#### 状态 Condition
会改变一个角色如何行动或改变一些统计数据的持续性效果，被称为状态。关于游戏中使用的基础状态相关规则，可以在本书后文中的“[附录：状态](http://45.79.87.129/bbs/index.php?topic=144022.msg1257871#msg1257871)”中找到。
#### 货币 Currency
游戏中最常见的货币是金币（gp）和银币（sp）。1gp价值10sp。此外，1sp价值10枚铜币（cp），而10gp价值1枚白金币（pp）。角色在游戏开始时拥有15gp（或150sp）用于购买装备。
#### 专长 Feat
专长是一种你可以为角色选择，基于其族裔、背景、职业、常规训练或技能训练的能力。有些专长提供了可以使用特殊动作的能力，有些则让你可以做的动作更加有效。
...
瓦莱洛斯（路易斯）： "你好，朋友！别害怕，我们是来帮忙的！" 我的外交检查得了 15 分。
...
> 梅丽希尔的匕首有一个名为 "多用（挥砍）"的特征，如果她选择的话，匕首可以造成挥砍伤害，而不是穿刺伤害。不幸的是，她刚才不知道在行动时这样做会更有效！
...
在开拓者2版规则中，角色以及他们的敌人通过使用动作以及由此产生的效果来与世界互动。这在每个动作都尤为重要的遭遇中最为明显。在使用1个动作后，你就能产生对应的效果。这效果可能是自动生效的，但很多时候进行动作需要你投掷1枚骰子，而动作的效果会与你投掷的结果相关。  
...
本节会手把手一步步地告诉你如何使用开拓者2版规则创建一名角色，但在此之前，必须先让你理解何为属性。这些数据是角色的重要组成部分，在接下来制作角色的多个步骤中，均会要求你在各种属性中进行选择。尽管本文提供了创建角色各步骤的推荐顺序，但你也可以按照自己喜欢的顺序完成这些过程。
    ...
    <table style="width:100%;border-collapse:collapse;border-spacing:0;table-layout: fixed" class="tg">
        ...
        <tbody>
            ...
            <tr>
                <td
                    style="background-color:#efe4d4;border-color:#efe4d4;border-style:solid;border-width:1px;color:#000000;font-family:Arial, sans-serif;font-size:14px;overflow:hidden;padding:10px 5px;text-align:left;vertical-align:top;word-break:normal">
                    游侠以掌控着周身的战斗环境来击破敌人，善用陷阱，常有动物伙伴。</td>
                <td
                    style="background-color:#ffffff;border-color:#ffffff;border-style:solid;border-width:1px;color:#000000;font-family:Arial, sans-serif;font-size:14px;overflow:hidden;padding:10px 5px;text-align:left;vertical-align:top;word-break:normal">
                    游荡者多才多艺且诡计多端，在意料不到时痛击敌人。</td>
                <td
                    style="background-color:#efe4d4;border-color:#efe4d4;border-style:solid;border-width:1px;color:#000000;font-family:Arial, sans-serif;font-size:14px;overflow:hidden;padding:10px 5px;text-align:left;vertical-align:top;word-break:normal">
                    女巫通过强大的魔宠来施放神秘庇护主的魔法。</td>
                <td
                    style="background-color:#ffffff;border-color:#ffffff;border-style:solid;border-width:1px;color:#000000;font-family:Arial, sans-serif;font-size:14px;overflow:hidden;padding:10px 5px;text-align:left;vertical-align:top;word-break:normal">
                    法师渊博的学者，通过对奥术魔法的钻研来释放强大的魔法。</td>
            </tr>
            <tr>
                <td style="background-color:#663234;border-color:#efe4d4;border-style:solid;border-width:1px;color:#ffffff;font-family:Arial, sans-serif;font-size:14px;overflow:hidden;padding:10px 5px;text-align:center;vertical-align:top;word-break:normal"
                    colspan="4"><span style="font-weight:bold;font-size: medium;">关键属性**</span></td>
            </tr>
            <tr>
                <td
                    style="background-color:#efe4d4;border-color:#efe4d4;border-style:solid;border-width:1px;color:#000000;font-family:Arial, sans-serif;font-size:14px;overflow:hidden;padding:10px 5px;text-align:center;vertical-align:top;word-break:normal">
...
>**\*\* 选择职业时，角色获得一次可以用于其关键属性的属性提升**

#### 六大属性
属性值是你的角色最重要的数据之一。这些数值代表了角色最基础的潜力，并会对角色卡上几乎所有其他数据产生影响。属性并非一口气便能立刻决定的数据，你需要在创建角色的数个步骤中逐渐构筑。
属性值可以分为两类：肉体（physical）和心智（mental）。力量、敏捷、体质是肉体属性值，它们用来衡量角色的体能强度。与之相对的，智力（Intelligence）、感知（Wisdom）和魅力（Charisma）是心智属性值，它们用来衡量角色的学习能力、意志力和人格力量。
某项属性值越优秀，与之相关的检定和与该属性相关联的能力就会越强，如下文所述。在预想自身角色的形象时，你也应当决定让角色哪些属性更加强大一些，以此来让你获得更多成功的机会。

##### 力量 Strength
力量用于衡量角色的体能强度。若你想让角色进行肉搏战的话，力量就很重要。你的力量调整值（Strength modifier）还会被添加到近战伤害检定（melee damage rolls）上，而且决定了你的角色能够背负多重的东西。

##### 敏捷 Dexterity
敏捷用于衡量角色的灵活性、平衡能力和反应速度。若你想让角色用远程武器进行攻击或者潜伏在暗处突袭敌人的话，敏捷就很重要。你的敏捷调整值（Dexterity modifier）还会被添加到角色的AC和反射豁免检定上。

##### 体质 Constitution
体质用于衡量角色的耐力以及身体是否强健。体质对于所有角色来说都是一项重要数值，而这对经常进行肉搏战的角色更为重要。你的体质调整值（Constitution modifier）会加到你的生命值和强韧豁免检定上。

##### 智力 Intelligence
智力用于衡量角色的学习和推理的能力。智力数值较高有助于让你的角色分析形势和理解各种符号的含义，而这也意味着她们能够在额外技能上得到训练，精通额外的语言。

##### 感知 Wisdom
感知用于衡量角色的常规感受力、认知能力与直觉。你的感知调整值还会添加到察觉以及意志豁免检定上。

##### 魅力 Charisma
魅力用于衡量角色的个人魅力与人格力量。魅力数值较高能帮助你影响他人的想法及情绪。

##### 属性值简介
每项属性起始都是+0，这代表了人类的平均水平，但你可以为角色做出选择，通过合适的**属性提升**来调整并增加这些属性，而属性缺陷（ability flaws）则会让属性减少。在创建角色的过程中，请记得在做出后述决定时对属性数值进行调整。  
[族裔](https://pf2.huijiwiki.com/wiki/%E6%97%8F%E8%A3%94 "族裔")：每个族裔都会提供**属性提升**，部分情况下会附带**属性缺陷**。若你选择承受**自选缺陷**（voluntary flaws）的话，请在该步骤应用至属性上。  
[背景](https://pf2.huijiwiki.com/wiki/%E8%83%8C%E6%99%AF "背景")：角色的背景会提供两次**属性提升**。  
[职业](https://pf2.huijiwiki.com/wiki/%E8%81%8C%E4%B8%9A "职业")：角色的职业会提供一次**属性提升**，该属性是对角色职业来说最重要的属性，也被称作[关键属性](https://pf2.huijiwiki.com/wiki/%E5%85%B3%E9%94%AE%E5%B1%9E%E6%80%A7 "关键属性")（key ability score）。  
决定属性值：在完成其他步骤之后，你可以自行分配四次**属性提升**。之后再基于最终的属性数值来确定你的**属性调整值**。

##### 属性提升
一次属性提升（Ability Boosts）通常会让一项属性的数值增加1点。然而当你想要应用属性提升的属性已经达到+4或更高的时候，一次属性提升应该记录下“**半次提升**”的勾选框。当属性已有一个半次提升时，对属性值加一并清空半次提升的勾选框。在1级时，角色的任何属性都不能高于+4。

当你的角色获得一次属性提升时，该规则会指明它是否必须应用到特定属性值，或两个特定属性值之一，或是一个能应用到任何你选择的属性值上的“自选”属性提升。例如矮人，会获得体质和感知的各一次属性提升，以及一次自选属性提升，这自选只能应用到除了体质和感知之外的属性上.

当你同时获得多次属性提升时，你必须将它们每一个应用到不同的属性上。这意味着你不能在获得“半次提升”的同时再次获得另一个“半次提升“，以此来提升该属性。

##### 属性缺陷
**属性缺陷（Ability Flaws）** 在开拓者2版规则里不像属性提升那样普遍。如果角色获得了一次属性缺陷——这通常来源于族裔——你要将对应属性的数值降低1点。

#### 信仰
或许你想扮演的角色是某个特定神祇的虔诚信徒。开拓者2版规则丰富的世界观里包含有数量庞大且各式各样的信仰与哲学观念，从侠肝义胆的酒醉英雄凯登·凯连；到星辰与梦境的女神——星域之歌黛丝娜；再到荣耀、正义和统治的女神——后继者艾奥梅黛。开拓者2版规则的主要神祇都收录于后文的[[PF2E Resources - Chinese/1-Player-Core-Ch1-CN#宗教\|#宗教]]章节中。你的角色可能会被某个信仰所吸引，并决定成为该神祇的神卫或牧师；当然，她们也可以只是在日常生活中遵循着这些神祇教义的虔诚信徒，或者是这些信徒的孩子而已。

#### 你的盟友
当你构筑自己的角色概念时，可能会想和其他玩家一起合作创建。你们的角色可能已经具有了某种共同点；她们可能是亲戚，或者出身自同一个村庄的旅行者。你也可以仅就规则层面与其他玩家进行讨论，创建出在战斗技巧方面能够相辅相成的角色。对于后者来说，如果在一个队伍里同时有角色担任伤害制造者、吸引火力的肉盾以及提供治疗的能手的话，会对冒险产生很大的帮助。但是无论如何，开拓者2版规则的职业中包含了许多选项，这使得在构筑各种类型的角色时都可以具有多个选择，因此你不需要被这种宽泛的类别限制了自己的选择。

>[!charactersheet|bg-c-yellow] 角色卡：第一步
>1. 当你构建出一个角色设定后，在你的角色卡第三页的笔记部分写下几句简单介绍。
>2. 在第一页记录下角色姓名。
>^csi1


![o90no4jrp7G3b2l](https://i.imgur.com/sAtkT1E.png)
![dQhVWf3gpvQmDIq](https://i.imgur.com/ityZ8Sz.png)
...
在此阶段，你需要开始构建角色的属性。见前面[[PF2E Resources - Chinese/1-Player-Core-Ch1-CN#六大属性\|属性概述]]的介绍以了解更多对于你的角色来说十分重要的内容，此外你也能对整个过程有个总体的了解。  

你角色的每项属性起始均为+0，在你选择自己的族裔（ancestry）、背景（background）和职业（class）后，应用你的属性提升（attribute boosts）和属性缺陷（ability flaws）。每次属性提升可以提升你的属性调整值+1， 属性缺陷则对属性调整值-1。在此时，你只需要在每项属性上填写好+0这个数字，然后熟悉上文中有关[[PF2E Resources - Chinese/1-Player-Core-Ch1-CN#属性提升\|属性提升和属性缺陷的规则]]。此时也是决定对于角色来说哪个属性最为重要的好时机。

>[!example] 举例：决定你的属性方向
>假设你想要玩一个帅气又矫捷的弓箭手，你可能希望重点关注角色的敏捷属性（影响角色使用远程武器的能力）和魅力属性（如果被抓了可以跑嘴皮子）。

详细请见上文的的[[PF2E Resources - Chinese/1-Player-Core-Ch1-CN#六大属性\|#六大属性]]以及各[[PF2E Resources - Chinese/1-Player-Core-Ch1-CN#职业导览\|#职业导览]]。

### 第三步：选择族裔
*Step 3 Select an Ancestry*

为你的角色选择一个族裔。[[PF2E Resources - Chinese/1-Player-Core-Ch1-CN#族裔导览\|#族裔导览]]提供了探索者规则的核心族裔选项，其列举的每个族裔都在本书的[第二章](https://www.goddessfantasy.net/bbs/index.php?topic=144034.0#:~:text=2%E3%80%81%E6%97%8F%E8%A3%94%E5%92%8C%E8%83%8C%E6%99%AF%20Ancestries%20%26%20Backgrounds)内有完整详细的介绍。族裔决定了角色的体型（size）、速度（Speed）和语言（languages），并影响角色的生命值（Hit Points）。族裔还会提供属性提升和属性缺陷，并以此来反应此类族裔的基础素质。  
当你为角色选择族裔时，要做出四个选择：  
...
>[!abstract] 角色卡
>1. 在第一页题头写下你的角色的族裔与传承。
>2. 如果你的族裔有属性提升或属性缺陷，在相应的属性值上加1或减1。
>3. 从你的族裔说明上找到你的起始HP值，记录下来。下面的步骤会继续增加这个值。
>4. 在第一页合适的空记下你的体型、速度、及语言。
>5. 如果你的族裔提供特殊能力，在合适的空白处填入。例如，黑暗视觉应该填到第一页的感官备注（Senses and Notes）中；任何内在法术应该填到第四页的内在法术栏中。 
>6. 最后，在第二页中填入一级选择的族裔专长。

> [!tip|bg-c-brown] 其他规则
> #### **替换属性提升** Alternative Attribute Boost
> 族裔中列出的属性提升和缺陷代表的是一般的趋势，或有助于指导玩家创造出该族裔最可能成为冒险者的角色。然而，族裔并非一成不变。你总是可以选择完全放弃族裔所列出的属性提升和缺陷，改为在创建你的角色时自由选择两个属性提升。 
...
你的角色的背景可能代表了她们所受到过的教育、自孩童时期便经受打磨的天赋、或者成为冒险者之前所经历过的人生。角色背景刊载于[第二章](https://www.goddessfantasy.net/bbs/index.php?topic=144329.0)。通常来说背景会提供两次属性提升（其中一次可能要在两个特定属性中进行选择，而另一个则是自由选择），一项特定技能（skill）受训、一项学识技能（Lore skill）受训、并获得一个特定的技能专长（skill feat）。 

>[!abstract] 角色卡
>1. 在第一页题头记录下你角色的背景。
>2. 调整你的属性调整值，选择背景提供的属性提升并对相应的属性+1。
>3. 在第二页，记录下背景提供的技能专长
>4. 在第一页上找到你背景特定的受训的技能，以及一项学识技能，将其标注为T（受训）。写下背景所提供的学识技能的名字。


### 第五步：选择职业
在此阶段，你需要决定角色的职业。职业会为你的角色赋予一整套强大的能力，这决定了她们要如何战斗，以及能够摆脱或避免哪些种类的有害效果。每个职业的完整介绍都刊载于[第三章](http://45.79.87.129/bbs/index.php?topic=144034.0#:~:text=Backgrounds%0A%E3%80%80%E8%AF%AD%E8%A8%80Languages-,3%E3%80%81%E8%81%8C%E4%B8%9AClasses,-%EF%BC%88%E5%BA%8F%E8%A8%80%EF%BC%89%0A%E3%80%80%E5%90%9F%E6%B8%B8)，不过[[PF2E Resources - Chinese/1-Player-Core-Ch1-CN#职业导览\|职业导览]]也会提供粗略的信息，告诉你对于扮演该职业来说何种属性是最为重要的。  
...
记住，每次属性提升都会让属性在基础的+1上增加1点，而每次属性缺陷都会使其减少1点。你的属性无法低于-1或高于+4。
...
### 第八步：购买装备
在1级时，你的角色有15金币（150银币）来购买盔甲、武器和其他基础装备。角色的职业会列出她们已经受训（甚至更强！）的武器和盔甲类型。角色的武器决定了在战斗中能够造成的伤害有多大，而盔甲则影响了角色的防御等级（Armor Class）；在第十步会有更多与计算相关数据的细节。不要忘记食物和旅行道具这样的物资！关于可用装备的价格以及更多细节，请见[第六章](https://www.goddessfantasy.net/bbs/index.php?topic=144216)。
...
#### 察觉（Perception）  
角色的察觉调整值（Perception modifier）衡量了她的警惕性有多强。该调整值等于角色在察觉上获得的熟练加值（proficiency bonus）加上感知调整值（Wisdom modifier）。更多的相关信息请见[第八章](http://45.79.87.129/bbs/index.php?topic=144679.msg1263348#msg1263348)。  
...
接下来将目光转移到你填写角色所使用的近战及远程武器的部分，计算使用每个武器进行打击（Strikes，一个动作，效果是进行一次攻击）时所使用的调整值，以及该武器的打击会造成多大的伤害。打击的调整值等同于角色使用对应武器时所获得的熟练加值（proficiency bonus）加上一项属性调整值（通常来说近战打击使用力量，而远程打击使用敏捷）。你还能添加来自武器的任何物品加值（item bonus）以及任何其他常驻（permanent）加值或减值。你还需要计算每件武器的打击所能造成的伤害。近战武器的伤害检定（damage rolls）通常要加上角色的力量调整值，而远程武器则可能要加上角色的部分或全部力量调整值，这取决于武器的特性（traits）。详细请见[第六章](http://45.79.87.129/bbs/index.php?topic=144216)来获得更多的信息。  
> [!tip|bg-c-brown] 法术与施法
> 大多数职业能够通过学习施放少量聚能法术（Focus Spells），但吟游诗人、牧师、德鲁伊、女巫和法师能够施法——施放各种数量繁多的法术的能力。若角色的职业能够获得法术，你应当在创建角色的第七步里学习与该职业相关的法术以及如何施法。角色卡的第四页给出了空间来让你记录角色的魔法系统、法术攻击检定的熟练度（proficiency rank）以及法术DC（spell DCs）。这里还提供了足够的空间记录角色的法术剧目或法术书中记载的法术，也可以用来记录你经常准备的法术。职业决定了角色能够施放的法术、施法方式、以及每日能够施放法术的次数，但关于法术本身以及施法的详细规则请见[第七章](http://45.79.87.129/bbs/index.php?topic=144034.0#:~:text=Weapons%0A%E3%80%80%E9%81%93%E5%85%B7Gear-,7%E3%80%81%E6%B3%95%E6%9C%AFSpells,-%E5%BA%8F%E8%A8%80%20%2D%20%E6%B3%95%E6%9C%AF%E8%A7%84%E5%88%99)。
...
#### 典范与禁忌（Edit and Anathema）
你可以通过添加典范与禁忌来强化你的角色的信仰、以及他们面对各种情况时的引导。
**典范**指的是你的个人哲学或信条。**禁忌**则恰恰相反：它们是与你的角度完全想法、冒犯你个人底线的行为。比如，你可以表明你遵循着“详细记录所有你探索过的地牢”的典范，或者你可以认为拒绝一位急需帮助的朋友为禁忌。
对于大多数角色来说，这些观点完全是可选的，但你最好思考是否在你创建角色的过程中选择几条来帮助你打磨你角色的思维模式。如果你信仰一位神祇，那么你可能会从宗教中列出的典范与禁忌中受到启发。族裔规则中列出了各个族群所视的典范与禁忌。
##### 必须的典范与禁忌
有些职业有一些绑定的禁忌；比如说，一位牧师从她的神祇处获得典范与禁忌。违反他们可能会导致你失去一些职业特性，直到你忏悔并补过之后（详见职业）。
##### 改变典范与禁忌
典范与禁忌可能会你玩这个角色的过程中演变，抑或是你发现你角色的行为反映着与你之前所想的不同的一套价值观。大多数时候，你可以直接改变相关的典范与禁忌，继续游戏。
...
#### 英雄点（Hero Points）
你的角色会在每个游戏团期（game session）的起始获得1点英雄点，你可以在这个团期（sessions）内通过作出英雄般的行为或谋划出巧妙的计策来获得额外英雄点。你的角色可以使用英雄点来获得某些好处，比如避免死亡或者重新投掷一次d20检定。关于英雄点详细内容[第八章](http://45.79.87.129/bbs/index.php?topic=144679.msg1263342#msg1263342)。  
...
## 升级 
[Leveling Up](https://2e.aonprd.com/Rules.aspx?ID=116)
...
你可以看到对于角色职业来说所有独有的新能力，比如职业专长（位于每个职业最初的介绍里），不过你也可以使用职业专长来选择一个变体（archetype），详见[第三章](http://45.79.87.129/bbs/index.php?topic=144210)。角色的职业介绍里还说明了如何应用角色获得的属性提升和技能提升（skill increases）。若角色会获得族裔专长，则需要回头翻看第二章，查看角色所选择的族裔，并从中选出另一个族裔专长。若角色会获得技能提升，则需要翻看第四章，来决定强化哪个技能。若角色获得了通用专长（General Feats）或技能专长（skill feat）则可以翻看第五章列出的专长，看看角色需要选哪个。若角色能够施法，则要在职业介绍里查看关于法术及法术位增加的相关信息。此时翻看第七章回顾一下角色的法术也是个好主意，你可以查看一下此时角色是否有能力施放相同法术的升阶版本。  
...
> [!todo|bg-c-brown] 升级备忘录
> 每当你升级的时候，都要确认后述各个事项：  
> - 将你的等级提升1级，从总经验值（XP）中扣除1000点经验值。
> - 根据[第三章](http://45.79.87.129/bbs/index.php?topic=144034.0#:~:text=Backgrounds%0A%E3%80%80%E8%AF%AD%E8%A8%80Languages-,3%E3%80%81%E8%81%8C%E4%B8%9AClasses,-%EF%BC%88%E5%BA%8F%E8%A8%80%EF%BC%89%0A%E3%80%80%E5%90%9F%E6%B8%B8)的职业介绍里所列出的数值来增加你的最高生命值。 
> - 根据职业升级表格添加职业特性，这包括属性提升与技能提升。 
> - 根据职业升级表格列出的内容选择专长。族裔专长见[第二章](http://45.79.87.129/bbs/index.php?topic=144034.0#:~:text=Sea%0A%E3%80%80%E5%AE%97%E6%95%99%20Religion-,2%E3%80%81%E6%97%8F%E8%A3%94%E5%92%8C%E8%83%8C%E6%99%AF,-Ancestries%20%26%20Backgrounds%20%EF%BC%88%E5%BA%8F%E8%A8%80)。职业专长见第三章的职业说明。通用专长与技能专长见[第五章](http://45.79.87.129/bbs/index.php?topic=144227.0)。 
> - 若你的职业能够施法，则添加法术与法术位。详见[第七章](http://45.79.87.129/bbs/index.php?topic=144034.0#:~:text=Weapons%0A%E3%80%80%E9%81%93%E5%85%B7Gear-,7%E3%80%81%E6%B3%95%E6%9C%AFSpells,-%E5%BA%8F%E8%A8%80%20%2D%20%E6%B3%95%E6%9C%AF%E8%A7%84%E5%88%99)关于法术的内容。
...
![txYKY7wR0BQeHeR](https://i.imgur.com/KK7Q37h.jpeg)
